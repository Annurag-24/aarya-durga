    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                ...
                setTitle(get("terms_conditions_title"));
                setSubtitle(get("terms_conditions_subtitle"));
                setContent(get("terms_conditions_content"));
                setHeroImage(
                    getImageUrl(findContentItem(pageData, "terms_conditions_image")) ||
